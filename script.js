$(document).ready(function() {
  const apiRoot = 'https://vast-depths-83309.herokuapp.com/v1/task/';
  const trelloApiRoot = 'https://vast-depths-83309.herokuapp.com/v1/trello/';
...
//   var apiRoot = 'https://vast-depths-83309.herokuapp.com/v1/task/';
